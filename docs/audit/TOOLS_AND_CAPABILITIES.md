...
| ----------------------------------------- | ---------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| Image generation                          | Available              | The `imagegen` skill and image-generation tool are present                              | Use only for Checkpoint 2 concept/texture drafts; no faces, fake UI, or embedded text                               |
