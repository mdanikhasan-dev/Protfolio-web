...
module.exports = {
  ...
  about: {
    ...
    extraHead: `  <meta property="profile:first_name" content="MD Anik">\n  <meta property="profile:last_name" content="Hassan">`,
    jsonLd: {
      '@context': 'https://schema.org',
      '@graph': [
        WEBSITE_SCHEMA_STUB,
  ...
  sitemap: {
    ...
    description: `Browse the main pages, blog posts, projects, and discovery resources for ${SITE_NAME}.`,
    robots: ROBOTS_DEFAULT,
    canonical: `${SITE_URL}/sitemap/`,
    ogType: 'website',
    ogDescription: `Browse the main pages, blog posts, projects, and discovery resources for ${SITE_NAME}.`,
    ogImage: OG_IMAGE,
    ogImageAlt: OG_IMAGE_ALT,
    themeColor: THEME_COLOR,
    googleVerification: null,
